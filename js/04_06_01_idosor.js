...
var line_040601 = d3.line()
    .x(function(d) {return scaleX_040601(d.date)})
    .y(function(d) {return scaleY_040601(d.ydata)})
    //.curve(d3.curveBasis);
...
d3.tsv("../../data/04_adossag/04_06_01_idosor.tsv", type, function (error, data) {
...
category_040601.append("path")
    .attr("class", "line")
    .attr("d", function(d) {return line_040601(d.values);} )
    .style("stroke", function(d) {return color_040601(d.name)} );
    ...
    .on("mousemove", function(){
        ...
        d3.selectAll(".mouse-per-line")
            .attr("transform", function(d, i) {
                ...
                bisect_040601 = d3.bisector(function(d) { return d.date;}).right;
                ...
                while (true){
                  ...
                  if ((target_040601 === end_040601 || target_040601 === beginning_040601) && pos_040601.x !== mouse_040601[0]) {break;}
                ...
                ypos_040601.push ({ind: i, y: pos_040601.y, off: 0});

                return "translate(" + mouse_040601[0] + ", " + pos_040601.y +")";
        })

        .call(function(sel) {
            ypos_040601.sort (function(a, b) { return a.y - b.y; });
            ...
            ypos_040601.sort (function(a, b) { return a.ind - b.ind; });
        })
