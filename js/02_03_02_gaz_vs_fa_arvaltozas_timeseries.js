...
var line_020302 = d3.line()
    .x(function (d) {
        return scaleX_020302(d.date)
    })
    .y(function (d) {
        return scaleY_020302(d.ydata)
    })
//.curve(d3.curveBasis);
...
d3.tsv("../../data/02_lakasminoseg_energiaszegenyseg/02_03_02_gaz_vs_fa_arvaltozas_timeseries.tsv", type_020302, function (error, data) {
    ...
    d3.min(categories_020302, function (c) {
            return d3.min(c.values, function (d) {
                return d.ydata * 1.15;
            });
        }),
    d3.max(categories_020302, function (c) {
            ...
            d3.selectAll(".mouse-per-line")
                .attr("transform", function (d, i) {
                    ...
                    var xDate_020302 = scaleX_020302.invert(mouse_020302[0]),
                        bisect_020302 = d3.bisector(function (d) {
                            return d.date;
                        }).right;
                    ...
                    while (true) {
                        ...
                        if ((target_020302 === end_020302 || target_020302 === beginning_020302) && pos_020302.x !== mouse_020302[0]) {
                            break;
                        }
