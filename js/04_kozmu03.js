...
var margin_kozmu03 = {top: width_abs_kozmu03/(820/40), right: 0, bottom: width_abs_kozmu03/(820/80), left: width_abs_kozmu03/(820/60)},
...
.rangeRound([0, width - width_abs_kozmu03/(820/150)])
.paddingInner(0.10)
.align(0.8);
...
svg_kozmu03.append('text')
		.attr('id', 'title_0304')
		.attr("x",  (width - width_abs_kozmu03/(820/150) )/2)
        .attr("font-size", width_abs_kozmu03/(820/17))
	...
	tooltip_kozmu03.append("rect")
		...
		.attr("height",width_abs_kozmu03/(820/20))
		.attr("fill", "white")
		.attr("stroke", "#666")
...
serie_kozmu03.append('text')
	.attr("class", "kozmu03_forras")
		.attr("x", width- width_abs_kozmu03/(820/150))
		.attr("y", height_kozmu03 + margin_kozmu03.top + margin_kozmu03.bottom*0.8)
        .attr("font-size", width_abs_kozmu03/(820/13))    
	.attr("text-anchor", "end")  
