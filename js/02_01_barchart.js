function BarChart() {
    ...
    function chart(selection) {
        selection.each(function (d, i) {
            ...
            color_11.domain(d3.keys(data_11[0]).filter(function (key) {
                return key !== "Régió";
            }));
            ...
            x_11.domain(data_11.map(function (d) {
                return d.Régió;
            }));
            y_11.domain([0, 1]);
            ...
            state_11.selectAll("rect")
                ...
                .style("fill", function (d) {
                    return color_11(d.name);
                });

            state_11.selectAll("rect")
                .on("mouseover", function () {
                    tooltip_11.style("display", null);
                })
                .on("mouseout", function () {
                    tooltip_11.style("display", "none");
                })
